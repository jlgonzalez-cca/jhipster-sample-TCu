...
public class ACCENTIDADDF implements Serializable {
    ...
    private ACCENTIDADDVT iDENTIDADFK1;

    @ManyToOne
    @JsonIgnoreProperties("aCCENTIDADDFS")
    private ACCENTIDADPER iDENTIDADFK2;
    ...
    public ACCENTIDADDVT getIDENTIDADFK1() {
        return iDENTIDADFK1;
    }

    public ACCENTIDADDF iDENTIDADFK1(ACCENTIDADDVT aCCENTIDADDVT) {
        this.iDENTIDADFK1 = aCCENTIDADDVT;
        return this;
    }

    public void setIDENTIDADFK1(ACCENTIDADDVT aCCENTIDADDVT) {
        this.iDENTIDADFK1 = aCCENTIDADDVT;
    }

    public ACCENTIDADPER getIDENTIDADFK2() {
        return iDENTIDADFK2;
    }

    public ACCENTIDADDF iDENTIDADFK2(ACCENTIDADPER aCCENTIDADPER) {
        this.iDENTIDADFK2 = aCCENTIDADPER;
        return this;
    }

    public void setIDENTIDADFK2(ACCENTIDADPER aCCENTIDADPER) {
        this.iDENTIDADFK2 = aCCENTIDADPER;
    }
