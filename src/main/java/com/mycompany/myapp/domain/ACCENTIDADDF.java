...
public class ACCENTIDADDF implements Serializable {
    ...
    @OneToMany(mappedBy = "iDENTIDADFK1")
    private Set<ACCENTIDADDVT> aCCENTIDADDVTS = new HashSet<>();

    @OneToMany(mappedBy = "iDENTIDADFK2")
    ...
    public Set<ACCENTIDADDVT> getACCENTIDADDVTS() {
        return aCCENTIDADDVTS;
    }

    public ACCENTIDADDF aCCENTIDADDVTS(Set<ACCENTIDADDVT> aCCENTIDADDVTS) {
        this.aCCENTIDADDVTS = aCCENTIDADDVTS;
        return this;
    }

    public ACCENTIDADDF addACCENTIDADDVT(ACCENTIDADDVT aCCENTIDADDVT) {
        this.aCCENTIDADDVTS.add(aCCENTIDADDVT);
        aCCENTIDADDVT.setIDENTIDADFK1(this);
        return this;
    }

    public ACCENTIDADDF removeACCENTIDADDVT(ACCENTIDADDVT aCCENTIDADDVT) {
        this.aCCENTIDADDVTS.remove(aCCENTIDADDVT);
        aCCENTIDADDVT.setIDENTIDADFK1(null);
        return this;
    }

    public void setACCENTIDADDVTS(Set<ACCENTIDADDVT> aCCENTIDADDVTS) {
        this.aCCENTIDADDVTS = aCCENTIDADDVTS;
    }
    ...
    public ACCENTIDADDF aCCENTIDADPERS(Set<ACCENTIDADPER> aCCENTIDADPERS) {
        this.aCCENTIDADPERS = aCCENTIDADPERS;
        return this;
    }

    public ACCENTIDADDF addACCENTIDADPER(ACCENTIDADPER aCCENTIDADPER) {
        this.aCCENTIDADPERS.add(aCCENTIDADPER);
        aCCENTIDADPER.setIDENTIDADFK2(this);
        return this;
    }

    public ACCENTIDADDF removeACCENTIDADPER(ACCENTIDADPER aCCENTIDADPER) {
        this.aCCENTIDADPERS.remove(aCCENTIDADPER);
        aCCENTIDADPER.setIDENTIDADFK2(null);
        return this;
    }
