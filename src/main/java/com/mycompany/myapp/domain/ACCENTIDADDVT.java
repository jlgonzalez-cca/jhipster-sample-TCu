...
public class ACCENTIDADDVT implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("aCCENTIDADDVTS")
    private ACCENTIDADDF iDENTIDADFK1;
    ...
    public ACCENTIDADDF getIDENTIDADFK1() {
        return iDENTIDADFK1;
    }

    public ACCENTIDADDVT iDENTIDADFK1(ACCENTIDADDF aCCENTIDADDF) {
        this.iDENTIDADFK1 = aCCENTIDADDF;
        return this;
    }

    public void setIDENTIDADFK1(ACCENTIDADDF aCCENTIDADDF) {
        this.iDENTIDADFK1 = aCCENTIDADDF;
    }
